from Python_courses.Lesson_4.waits_practice.registration.locators import HEADER, START_TESTING_BUTTON, LOGIN_FIELD, PASSWORDD_FIELD, AGREE_CHECKBOX, REGISTRATION_BUTTON, \
    LOADER, SUCCESS_MESSAGE
from Python_courses.Lesson_4.waits_practice.registration.data import REGISTRATION_PAGE,PASSWORD
from selenium.webdriver.support import expected_conditions as EC

from Python_courses.Lesson_4.waits_practice.conftest import driver,options,wait
